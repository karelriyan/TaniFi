...
export const CONTRACT_ADDRESSES = {
  TANI_VAULT: process.env.NEXT_PUBLIC_TANI_VAULT_ADDRESS || '0x0000000000000000000000000000000000000000',
  IDRX: process.env.NEXT_PUBLIC_IDRX_ADDRESS || '0x0000000000000000000000000000000000000000',
  FARMER_REGISTRY: process.env.NEXT_PUBLIC_FARMER_REGISTRY_ADDRESS || '0x0000000000000000000000000000000000000000',
};
